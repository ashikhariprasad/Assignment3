...
public class BaseController {
	...
	@ResponseBody
	public UserObj createUser(@RequestBody @Valid User usr){
	...
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	public IDCardDetail createIDCard(@PathVariable  String userId,@RequestBody @Valid IDCard idcard){
	...
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	public WebLogin createWebLogin(@PathVariable String userId,@RequestBody @Valid WebLogin webLogin){
	...
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	public BankAccount createBankAccount(@PathVariable String userId,@RequestBody @Valid BankAccount bankAccount){
	...
	@ResponseBody
	public FailureMessage handleException(Exception e, HttpServletResponse response){
	response.setStatus(400);
	return new FailureMessage(e.toString());
	}
